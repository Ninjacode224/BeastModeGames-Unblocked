  ...
  return (
    <div className={styles.main}>
      <Head>
        ...
        <title>Beast Mode Games - Offline</title>
      ...
      <main className={styles.main}>
        ...
        <div id={styles['main-page-content']}>
          ...
          <div id={styles["main-page-init"]}>
            <h1 className={styles["main-title"]}><span>Beast Mode Games</span> <FaGithub style={{"cursor": "pointer"}} onClick={(e) => {window.open('https://github.com/Beast Mode Gamesdevelopment/ludi');}} /></h1>
